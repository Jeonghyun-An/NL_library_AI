          ...
          <article class="skx-book-card skx-book-card--hd">
            ...
            <div class="skx-book-card__body">
              ...
              <div class="skx-book-card__actions">
                <button type="button"
                  :class="['skx-btn-talk skx-btn-talk--book', chatPanelOpen && 'is-active']"
            ...
            <div class="skx-curation-panel">
              ...
              <div class="skx-curation-content">
                <div class="skx-curation-card">
                  ...
                  <p v-else-if="detailTab === 'plot'" class="skx-curation-text">{{ book.plot || book.summary || '줄거리 정보가 없습니다.' }}</p>
                  <p v-else-if="detailTab === 'intro'" class="skx-curation-text">{{ book.introduction || '소개 정보가 없습니다.' }}</p>
                  <p v-else-if="detailTab === 'effect'" class="skx-curation-text">{{ book.read_effect || '정보가 없습니다.' }}</p>
                </div>
              </div>
            </div>
          </section>
              ...
              <div class="skx-reco-list" role="list">
                ...
                <button v-for="rel in relatedItems" :key="rel.book_id"
                  ...
                  <div class="skx-reco-item__inner">
                    ...
                    <span class="skx-reco-item__score">정합성 {{ Math.round((rel.score || rel.best_score || 0) * 100) }}%</span>
                  </div>
                </button>
              </div>
              ...
              <div v-else class="skx-reco-detail">
                ...
                <div class="skx-reco-info">
                  ...
                  <button class="skx-btn-loan" style="margin-top:12px"
                    @click="navigateTo(`/books/${selectedRelated.book_id}?q=${encodeURIComponent(searchQuery)}`)">상세 보기</button>
                </div>
              </div>
            </div>
          </section>

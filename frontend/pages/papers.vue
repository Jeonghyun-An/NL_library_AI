      ...
      <div class="skx-result-card">
        ...
        <template v-else>
          ...
          <div v-else class="skx-paper-list">
            ...
            >
              <article
                class="skx-paper-card"
                style="cursor: pointer"
                @click="
                  navigateTo(
                    `/papers/${paper.book_id}?q=${encodeURIComponent(currentQuery)}`,
                  )
                "
              >
                <div class="skx-paper-card__main">
                  ...
                  <div class="skx-paper-card__meta">
                    ...
                    >
                    <span
                      v-if="paper.book_info?.publisher"
                      class="skx-dot"
                    ></span>
                    <span
                      v-if="paper.book_info?.publisher"
                      class="skx-meta-text"
                      >{{ paper.book_info.publisher }}</span
                    >
                    <span
                      v-if="paper.book_info?.pub_date"
                      class="skx-dot"
                    ></span>
                    <span
                      v-if="paper.book_info?.pub_date"
                      class="skx-meta-text"
                      >{{ paper.book_info.pub_date }}</span
                    >
                  </div>
                  <p
                    v-if="paper.book_info?.abstract"
                    class="skx-paper-card__abstract"
                  >
                  ...
                  <div class="skx-paper-card__actions" @click.stop>
                    <button
                      type="button"
                      class="skx-btn-talk skx-btn-talk--paper"
                      @click="
                        navigateTo(
                          `/papers/${paper.book_id}?q=${encodeURIComponent(currentQuery)}`,
                        )
                    ...
                    >
                      <span
                        class="skx-btn-talk__glow"
                        aria-hidden="true"
                      ></span>
                      <span
                        class="skx-btn-talk__panel"
                        aria-hidden="true"
                      ></span>
                      <img
                ...
                <div class="skx-paper-card__side">
                  <div class="skx-paper-card__score">
                    {{ Math.round((paper.best_score || 0) * 100)
                    }}<span>%</span>
                  </div>
